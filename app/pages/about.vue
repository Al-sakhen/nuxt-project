...
useHead({
    title: "About - SmartZone",
    meta: [
        {
            name: "description",
            content: "Learn more about SmartZone, our mission, and our team.",
        },
        {
            name: "keywords",
            content:
                "SmartZone, about, mission, team, contact, company information",
        },
        {
            name: "author",
            content: "SmartZone Team",
        },
        {
            name: "viewport",
        ...
        {
            name: "og:title",
            content: "About SmartZone - Our Mission and Team",
        },
        {
            name: "og:description",
            content:
                "Discover more about SmartZone, our mission to revolutionize the industry, and meet our dedicated team.",
        },
        {
            name: "og:image",
            content: "/images/about-og-image.jpg",
        },
        {
            name: "og:url",
            content: "https://www.smartzone.com/about",
        },
        {
            name: "og:type",
            content: "website",
